<template>
  <div>
    <Header></Header>
    <div class="container">
      <h1 class="text-center">Shахsiyat tеsti vа ishdаn qаnоаtlаnish</h1>
      <div class="on-test">
        <div class="one_test_progress">
          ...
          <div class="on-test-card">
            <div>
              ...
              <div class="quiz_error">
                <div>
                  Har xil variant tanlang
                </div>
              </div>
            </div>
          </div>
